/** Feature catalog: every dsh-studio-* feature the aggregate exposes. */
...
export const FEATURES: readonly Feature[] = [
  {
    id: 'dsh-studio-notifier',
    name: '桌面通知',
    description: '任务完成 / 需要关注时发送桌面通知',
  },
  {
    id: 'dsh-studio-scheduler',
    name: '定时任务',
    description: '按 cron 表达式周期执行任务',
  },
  {
    id: 'dsh-studio-lan-auth',
    name: '局域网鉴权网关',
  ...
  },
  {
    id: 'dsh-boost-mode',
    name: 'Boost Mode',
    description: 'Boost Mode（满血模式）：Minimal 工具引导（bash/str_replace_editor）→ 首次晋升后开放完整工具；导入 preset 到 ~/.dsh/.agent-presets/boost-mode（基于 dsh-anchored-standard），按需 discovery 解锁更重工具',
    defaultEnabled: true,
    installable: true,
    togglable: false,
  },
