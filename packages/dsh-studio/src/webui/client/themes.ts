 ...
 *
 * 持久化：localStorage（一机一份）；host 侧另有 `/dsh-studio-webui/themes`
 * JSON 落盘（跨浏览器续传）。
 */
...
export const BUILTIN_THEMES: readonly WebUITheme[] = Object.freeze([
  ...
  ...family(
    ...
    '海洋 Ocean',
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #4f9cf9 9%, transparent) 0%, transparent 60%), var(--dsw-specific-sidebar-fill)',
    },
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #2f7fd9 11%, transparent) 0%, transparent 62%), var(--dsw-specific-sidebar-fill)',
    },
  ),
  ...family(
    'sakura',
  ...
  ...family(
    ...
    '深空 Space',
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #7c9cf5 8%, transparent) 0%, transparent 60%), var(--dsw-specific-sidebar-fill)',
    },
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #4f6fe0 10%, transparent) 0%, transparent 62%), var(--dsw-specific-sidebar-fill)',
    },
  ),
  ...family(
    'graphite',
  ...
  ...family(
    ...
    '霓虹 Neon',
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #a78bfa 10%, transparent) 0%, transparent 60%), var(--dsw-specific-sidebar-fill)',
    },
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #8b5cf6 12%, transparent) 0%, transparent 62%), var(--dsw-specific-sidebar-fill)',
    },
  ),
  ...family(
    'solar',
    '暖阳 Solar',
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #f59e0b 9%, transparent) 0%, transparent 60%), var(--dsw-specific-sidebar-fill)',
    },
    {
      ...
      '--dsh-studio-frame-grad': 'radial-gradient(140% 70% at 50% -20%, color-mix(in srgb, #d97706 12%, transparent) 0%, transparent 62%), var(--dsw-specific-sidebar-fill)',
    },
  ),
])
...
const LS_KEY = 'dsh-studio-webui.themes.v1'
